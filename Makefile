# Makefile — BOMJINIKA Kernel M0
EFIINC = /usr/include/efi
EFIINC_ARCH = /usr/include/efi/x86_64
CFLAGS = -I$(EFIINC) -I$(EFIINC_ARCH) -fshort-wchar -fPIC -DEFI_FUNCTION_WRAPPER -Wall -O2
...
BOMJINIKA.o: kernel.c
	$(CC) $(CFLAGS) -c kernel.c -o BOMJINIKA.o

BOMJINIKA.so: BOMJINIKA.o
	ld $(LDFLAGS) BOMJINIKA.o $(LIBS) -o BOMJINIKA.so
